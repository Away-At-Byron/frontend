  ...
  return (
    <div
      style={{
        ...
        fontFamily: "var(--font-sans), sans-serif", color: "var(--ink)",
      }}
    >
      {/* ── Sidebar ── */}
      <aside
        style={{
          ...
          background: "var(--linen)", display: "flex", flexDirection: "column",
      ...
      >
        <div style={{ padding: "24px 22px 18px", display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <div style={{ fontFamily: "var(--font-display), serif", fontSize: 16, lineHeight: 1, fontWeight: 400 }}>
        ...
        <div style={{ padding: "8px 14px 4px", position: "relative" }}>
          <button
            ...
            style={{
              ...
              gap: 10, background: "var(--shell)", border: "1px solid var(--line-soft)",
              borderRadius: "var(--r-2)", padding: "10px 12px", cursor: "pointer",
              font: "inherit", color: "var(--ink)",
            }}
          >
            <Icon name="House" size={16} strokeWidth={1.6} />
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontFamily: "var(--font-display), serif", fontSize: 14, fontWeight: 400, lineHeight: 1, fontStyle: "italic" }}>
                {property.name}
              </div>
          ...
          {propOpen && (
            <div
              style={{
                ...
                zIndex: 10, background: "var(--paper)", border: "1px solid var(--line)",
                borderRadius: "var(--r-2)", boxShadow: "var(--shadow-pop)", padding: 6,
              }}
            >
              {PROPERTIES.map((p) => (
                <button
                  ...
                  style={{
                    ...
                    background: property.id === p.id ? "var(--shell)" : "transparent",
                    border: "none", cursor: "pointer", font: "inherit", color: "var(--ink)",
                    display: "flex", justifyContent: "space-between", alignItems: "center",
                  }}
                >
                  <span style={{ fontFamily: "var(--font-display), serif", fontStyle: property.id === p.id ? "italic" : "normal" }}>
                    {p.name}
                  </span>
        ...
        <div style={{ marginTop: "auto", padding: "14px 14px 18px", borderTop: "1px solid var(--line-soft)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontFamily: "var(--font-display), serif", fontSize: 14, fontWeight: 400, lineHeight: 1.1 }}>
                {user.name}
              </div>
              <div className="caps" style={{ fontSize: 9, color: "var(--ink-faint)", marginTop: 2, textTransform: "capitalize" }}>
                {user.role.replace(/_/g, " ")}
              </div>
            </div>
            <IconButton size={30} variant="quiet" title="Sign out" onClick={() => signOut({ callbackUrl: "/signin" })}>
      ...
      <main style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            <div className="caps" style={{ color: "var(--ink-faint)", fontSize: 10 }}>
              {todayLabel()} · {property.name}
            </div>
            <div
              style={{
                fontFamily: "var(--font-display), serif", fontWeight: 300, fontSize: 28,
          ...
          >
            ...
            />
            <span className="mono" style={{ fontSize: 10, color: "var(--ink-faint)", padding: "2px 6px", background: "var(--shell)", borderRadius: 4 }}>
              ⌘K
            </span>
          </div>
          ...
          <Link href="/bookings/new">
            <Button variant="primary" size="md" icon={<Icon name="Plus" size={15} />}>
              New booking
            </Button>
          </Link>
        </div>
