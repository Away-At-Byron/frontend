...
import { NewContactTypeModal, EditContactTypeModal } from "./contact-type-modal"
...
function sortByName(rows: ContactTypeRow[]): ContactTypeRow[] {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        >
          The categories a contact can be filed under, like Guest, Owner or
        ...
        <div style={{ overflowX: "auto" }}>
          <div style={{ minWidth: 800 }}>
            ...
            {filtered.length === 0 ? (
              ...
              >
                {types.length === 0
                  ? "No contact types yet. Add the first one."
                  : "No contact types match this search."}
              </div>
            ) : (
              filtered.map((t, i) => (
                <div
                ...
                >
                  ...
                  <span>
                    <Pill tone={t.contactCount > 0 ? "info" : "neutral"}>
                      {t.contactCount} contact
                      {t.contactCount === 1 ? "" : "s"}
                    </Pill>
                  </span>
